...
nn2_history = nn2.fit(X_train, y_train, epochs = 50, verbose=1, validation_data=(X_test, y_test), callbacks=[csv_logger])
nn2_score = nn2.evaluate(X_test, y_test)
nn2_score2 = nn2.evaluate(X_test2, y_test2)

print('Test score:', nn2_score[0])
print('Test accuracy:', nn2_score[1])

print('Test score2:', nn2_score2[0])
print('Test accuracy2:', nn2_score2[1])

plot_model_history(nn2_history)
