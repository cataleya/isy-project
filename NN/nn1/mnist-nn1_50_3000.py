...
nn1_history = nn1.fit(X_train, y_train, epochs = 50, verbose=1, validation_data=(X_test, y_test), callbacks=[csv_logger])
nn1_score = nn1.evaluate(X_test, y_test)
nn1_score2 = nn1.evaluate(X_test2, y_test2)

print('Test score:', nn1_score[0])
print('Test accuracy:', nn1_score[1])

print('Test score2:', nn1_score2[0])
print('Test accuracy2:', nn1_score2[1])
