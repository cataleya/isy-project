...
nn3_history = nn5.fit(X_train, y_train, epochs = 50, verbose=1, validation_data=(X_test, y_test), callbacks=[csv_logger])
nn3_score = nn5.evaluate(X_test, y_test)
nn3_score5 = nn5.evaluate(X_test2, y_test2)

print('Test score:', nn5_score[0])
print('Test accuracy:', nn5_score[1])

print('Test score2:', nn5_score2[0])
print('Test accuracy2:', nn5_score2[1])
