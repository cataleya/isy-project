...
nn4_history = nn4.fit(X_train, y_train, epochs = 30, verbose=1, validation_data=(X_test, y_test), callbacks=[csv_logger])
nn4_score = nn4.evaluate(X_test, y_test)
nn4_score2 = nn4.evaluate(X_test2, y_test2)

print('Test score:', nn4_score[0])
print('Test accuracy:', nn4_score[1])

print('Test score2:', nn4_score2[0])
print('Test accuracy2:', nn4_score2[1])

plot_model_history(nn4_history)
